	...
	<div class="row">
      <div class="large-12 columns">
      	<div class="panel">
			...
			if($_GET["rc"]==1)
            {
                        echo "Your Note Deleted!<br>";
			}
			if($_GET["edit"]==1)
            {
                        echo "Your Note Edited!<br>";
			}
			
			?>
			
			Your Notes...</h3></center></b>
...
<tr>
	...
	?></td>
    <td width="95"><a href="edit.php?no=<?php echo $row['no.']; ?>" >Edit</a>&nbsp;
	 <a href="seenote.php?no=<?php echo $row['no.']; ?>"">See</a>&nbsp;
